...
const server = http.createServer((req, res) => {
  ...
  if (req.url === "/") {
    ...
    res.end(`
            ...
            <p> Hi, My name is Abhinav Bajpai. I am from Lucknow, UttarPradesh . 
    ...
    console.log(
      "Hi, My name is Abhinav Bajpai. I am from Lucknow, UttarPradesh . I am currently doing B.Tech CSE Core from K.R. Mangalam University, Gurugram, Haryana ",
    );
